...
In both cases Nao will help you.
...
<code>(file)</code>: required file, if file isn't provided you will be entered in file state, this means Nao will wait file message from you. Type /cancel to leave from it.
